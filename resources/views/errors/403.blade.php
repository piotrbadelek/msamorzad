...
@section("explanation", "Twoje konto nie posiada odpowiednich uprawnień do wykonania tej akcji. Jeżeli uważasz, iż jest to pomyłka, skontaktuj się z pomocą techniczną.")
@section("svgContent")
	<path
