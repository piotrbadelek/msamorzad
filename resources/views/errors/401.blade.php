...
@section("explanation", "Nie jesteś zalogowany, lub zalogowałeś się niepoprawnie. W przypadku dalszych problemów spróbuj się wylogować i zalogować ponownie; Możesz również skontaktować się z pomocą techniczną.")
@section("svgContent")
	<path
